...
const XFactorLanding = () => {
    ...
    return (
        ...
        .animate-scroll-img {
          animation: alternateScroll 3s infinite alternate ease-in-out;
        }
      `}</style>
            <header
                className="fixed top-0 w-full z-50 bg-white shadow-sm flex justify-between items-center px-6 py-4 md:px-10">
                <div className="logo">
                    <img src="XFactor main logo.jpg" alt="X-Factor Logo" className="h-16 ml-0 md:ml-12"/>
                </div>
            ...
            >
                ...
                <div className="relative z-10">
                    <h1 className="text-4xl md:text-7xl font-extrabold mt-[-3rem]">
                        Your <span
                        className="inline-block text-orange-400 transition-opacity duration-500 animate-fade-in">
                ...
                <div className="max-w-6xl mx-auto flex flex-wrap items-center gap-10">
                    <div className="w-full lg:w-1/2">
                        <img
                            ...
                            className="w-full rounded-lg shadow-lg object-cover h-[380px]"
                        />
                    </div>
                    <div className="flex-1 min-w-[300px]">
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed text-lg">
                            ...
                            understand your goals and skill level, and create a custom learning path just for you. We're
            ...
            <section className="py-16 px-5 max-w-6xl mx-auto">
              ...
              `}>
                            ...
                            <div
                                ...
                                <a href="./form.htm" className="text-blue-500 font-medium hover:underline">Enroll Now
                                    →</a>
                            </div>
                    ...
                    {[
                        ...
                        <div key={idx}
                            ...
                            <div className="relative h-48 overflow-hidden">
                                ...
                                <span
                                    className="absolute bottom-2 left-3 bg-blue-600 text-white px-2 py-1 text-xs font-bold rounded">{prog.tag}</span>
                                <span
                                    className="absolute top-2 right-3 bg-yellow-400 text-white text-xs px-2 py-1 rounded font-bold">Featured</span>
                                {prog.overlay && (
                                    <div
                                        className="absolute inset-0 bg-black/60 flex items-center justify-center text-white text-xl font-bold pt-20">
                                        {prog.overlay}
                                    </div>
                                )}
                            </div>
            ...
            <footer id="contactUs" className="bg-[#1d1f23] text-white py-12 px-5">
                <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-8">
                    ...
                    <div className="flex-1 min-w-[250px]">
                        <img src="XFactor main logo.jpg" alt="Logo" className="w-32 mb-4"/>
