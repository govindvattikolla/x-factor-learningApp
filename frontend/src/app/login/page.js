...
import AuthAside from "@/components/Authside";
...
const AuthPage = () => {
    ...
    return (
        <div className="min-h-screen flex justify-center items-center p-4 md:p-8 bg-gray-50 font-sans text-gray-800">
            <div className="flex w-full max-w-6xl min-h-[600px] bg-white rounded-2xl overflow-hidden shadow-2xl flex-col lg:flex-row">
                <AuthAside />
                ...
                <div className="flex-1 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    {error && (
                        <div className="mb-6 p-4 rounded-lg bg-red-50 border border-red-100 flex items-center text-red-600 text-sm animate-fade-in">
