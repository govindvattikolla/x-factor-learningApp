            ...
            <Container>
                <Row className="mb-5">
                    <Col lg={8} className="mx-auto text-center ">
                        ...
                        <p className="lead">Comprehensive programs designed to help you stand out in today's competitive
                            job market</p>
                    </Col>
                </Row>
                        ...
                        <Col key={course.id} xs={10} md={6}>
                            <Card className="h-100 border-0 shadow-lg hover-card"
                                ...
                                <div className="position-relative">
                                    ...
                                    {course.featured && (
                                        <Badge bg="warning"
                                               className="position-absolute top-0 end-0 m-2">Featured</Badge>
                                    )}
                                    <Badge bg="primary"
                                           className="position-absolute bottom-0 start-0 m-2">{course.category}</Badge>
                                </div>
